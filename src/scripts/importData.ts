...
export async function runImport() {
  ...
  for (const m of members) await addDoc(collection(t(), "members"), m);
  console.log("✅ 成員匯入完成");
  const events = [
    { date: "2026-04-23", startTime: "06:50", endTime: "09:20", title: "TPE → OKA 台灣虎航 IT230", location: "桃園國際機場 T1", category: "transport", notes: "有免費貴賓室，建議提早到", mapUrl: "", cost: 0, currency: "JPY", createdAt: Timestamp.now() },
    ...
    { date: "2026-04-23", startTime: "16:30", title: "Check-in 雷克沖繩北谷溫泉度假村", location: "沖繩縣中頭郡北谷町字美濱34番地2", category: "hotel", notes: "14:00可Check-in，設有天然溫泉及高空無邊際泳池", mapUrl: "https://share.google/c6eO7mgX4n2TkEvg9", cost: 0, currency: "JPY", createdAt: Timestamp.now() },
    ...
    { date: "2026-04-24", startTime: "12:30", title: "沖繩美麗海水族館", location: "沖繩縣國頭郡本部町字石川424番地", category: "attraction", notes: "營業時間 08:30-18:30", mapUrl: "https://share.google/GV2tUlnNeHf7Ld67n", cost: 0, currency: "JPY", createdAt: Timestamp.now() },
    { date: "2026-04-24", startTime: "13:00", title: "海豚劇場 海豚秀", location: "美麗海水族館內", category: "attraction", notes: "提早10分鐘占位子", mapUrl: "", cost: 0, currency: "JPY", createdAt: Timestamp.now() },
    ...
    { date: "2026-04-24", startTime: "17:30", title: "Check-in 沖繩逸之彩飯店", location: "沖繩縣那霸市牧志3丁目18番33號", category: "hotel", notes: "15:00可Check-in，設有露天溫泉、免費宵夜拉麵暢飲", mapUrl: "https://share.google/uFxCdkeWJ0tBQoViF", cost: 0, currency: "JPY", createdAt: Timestamp.now() },
    ...
    { date: "2026-04-25", startTime: "18:00", title: "國際通商店街必吃", location: "沖縄県那覇市牧志3丁目2-10", category: "food", notes: "🍦Blue Seal冰淇淋｜🍙豬肉蛋飯糰｜🧂鹽屋雪鹽冰淇淋｜🍟Calbee+現炸薯條｜🥐御菓子御殿紅芋塔｜🎂FUKUGIYA黑糖年輪蛋糕", mapUrl: "", cost: 0, currency: "JPY", createdAt: Timestamp.now() },
  ...
  const bookings = [
    { type: "flight", direction: "outbound", airline: "台灣虎航", flightNo: "IT 230", departure: { airport: "TPE", airportName: "台北桃園" }, arrival: { airport: "OKA", airportName: "沖繩那霸" }, passengers: ["uu", "brian"], notes: "有加購貴賓室", costPerPerson: 0, currency: "TWD", createdAt: Timestamp.now() },
    { type: "flight", direction: "inbound", airline: "樂桃航空", flightNo: "MM 929", departure: { airport: "OKA", airportName: "沖繩那霸" }, arrival: { airport: "TPE", airportName: "台北桃園" }, passengers: ["uu", "brian"], notes: "", costPerPerson: 10017, currency: "TWD", createdAt: Timestamp.now() },
    { type: "hotel", name: "雷克沖繩北谷溫泉度假村", nameJa: "レクー沖縄北谷スパ&リゾート", address: "沖繩縣中頭郡北谷町字美濱34番地2", roomType: "海景雙人房", totalCost: 3943, currency: "TWD", costPerPerson: 1971.5, confirmCode: "1616327200916576", notes: "緊鄰美國村，設有天然溫泉及高空無邊際泳池", mapUrl: "https://share.google/c6eO7mgX4n2TkEvg9", createdAt: Timestamp.now() },
    { type: "hotel", name: "沖繩逸之彩飯店", nameJa: "沖縄逸の彩 温泉リゾートホテル", address: "沖繩縣那霸市牧志3丁目18番33號", roomType: "大床房", totalCost: 6929, currency: "TWD", costPerPerson: 3464.5, confirmCode: "1616327200935988", notes: "設有露天溫泉、游泳池，提供免費宵夜拉麵暢飲", mapUrl: "https://share.google/uFxCdkeWJ0tBQoViF", createdAt: Timestamp.now() },
    { type: "car", company: "OTS", pickupLocation: "OTS 臨空豐崎營業所（那霸機場）", returnLocation: "OTS 臨空豐崎營業所（那霸機場）", carType: "S級別 1台", totalCost: 26290, currency: "JPY", confirmCode: "OTS1402455", notes: "需國際駕照+日文譯本，機場報到需出示QR Code", createdAt: Timestamp.now() },
  ];
  for (const b of bookings) await addDoc(collection(t(), "bookings"), b);
  console.log("✅ 預訂匯入完成");
  const lists = [
  ...
  for (const l of lists) await addDoc(collection(t(), "lists"), l);
  console.log("✅ 清單匯入完成");
  console.log("🎉 全部完成！");
}
